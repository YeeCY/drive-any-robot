...
def main(args: argparse.Namespace):
    ...
    # folder_names = folder_names[:32]  # recon_32_trajs
    ...
    # recon_32_trajs, recon_10_trajs, recon_3_trajs, recon_2_trajs
    ...
    test_dir = os.path.join(DATA_SPLITS_DIR, args.dataset_name, "test")
